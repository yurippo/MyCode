##frozen sets are nothing more than imutable sets
###they remain the same after creation due to this feature frozen sets can be used as elements of another set or as a key in a python dictionary

list1 = [1,2,3,4]
list2 = [3,4,7]

###now let's create our frozen set passing this lists to a frozen set function
...
#fs1.add(10)####this will get an error cannot edit a frozenset

#fs1.remove(1)####this will get an error cannot edit a frozenset

#fs1.pop() ####this will get an error cannot edit a frozenset

fs1.intersection(fs2) ##It's possible doesn't modify the content

fs1.difference(fs2)##It's possible doesn't modify the content

fs1.union(fs2)##It's possible doesn't modify the content
